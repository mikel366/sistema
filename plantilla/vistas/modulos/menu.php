        ...
        <ul class="app-menu">
            ...
            <li class="menu-item">
                <a href="categorias" class="menu-link waves-effect waves-light">
                    <span class="menu-icon"><i class="mdi mdi-creation"></i></span>
            ...
            <li class="menu-item">
                <a href="carrito" class="menu-link waves-effect waves-light">
            ...
            <li class="menu-item">
                <a href="configuracion" class="menu-link waves-effect waves-light">
